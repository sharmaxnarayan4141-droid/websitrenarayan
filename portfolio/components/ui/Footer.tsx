      ...
      <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center md:items-start gap-1">
          ...
          <div className="flex items-center gap-1 text-muted">
            ...
            <span className="font-sans text-xs uppercase tracking-[0.15em]">Jodhpur, Rajasthan, India</span>
          </div>
        </div>

        {/* Center */}
        <p className="font-sans text-xs uppercase tracking-[0.2em] text-muted">
          © 2025 Narayan Sharma. All rights reserved.
        </p>
        ...
        <div className="flex items-center gap-6">
          ...
          >
            <GitHubIcon />
            <span className="text-xs uppercase tracking-widest hidden md:block">GitHub</span>
          </a>
        </div>
      </div>
    </motion.footer>
